    ...
    handleSaveUSer = () => {
        ...
        let {action}= this.state;
            ...
            if(action===CRUD_ACTIONS.EDIT){
                ...
                console.log('check this.props.editUser',this.props.editUser);
            }
                        ...
                        <div className="row">
                            ...
                            <div className='col-12 my-3'>
                                <button
                                    ...
                                    className={this.state.action===CRUD_ACTIONS.EDIT?'btn btn-warning button_handle':'btn btn-primary button_handle'}

                                    onClick={() => this.handleSaveUSer()}
                                >
                                {this.state.action===CRUD_ACTIONS.EDIT?<FormattedMessage id="manager-user.edit" />:<FormattedMessage id="manager-user.save" />}
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        editUser: (data) => dispatch(actions.editAUser(data)),
